  ...
  <div class="max-w-2xl mx-auto space-y-8">
    ...
    <section class="bg-ink-850 rounded-xl border hair p-5 space-y-4">
      ...
      <div class="space-y-2">
        ...
        >
          <template v-if="editingTagId === tag.id">
            <input v-model="editTagLabel" type="text" class="field flex-1 px-2 py-1 rounded text-sm">
      ...
      <div class="flex items-center gap-2 pt-2 border-t hair">
        ...
        <button type="button" class="addbtn px-3 py-2 rounded-lg text-sm font-medium" @click="handleCreateTag">
          Add
        </button>
      </div>
    </section>
